...
class OverlayState {
  ...
  OverlayState copyWith({
    ...
    return OverlayState(
      ...
      lastCaptureText: lastCaptureText ?? (clearCapture ? null : this.lastCaptureText),
      lastCaptureError: lastCaptureError ?? (clearError ? null : this.lastCaptureError),
      isCapturing: isCapturing ?? this.isCapturing,
      summary: summary ?? (clearCapture ? null : this.summary),
      keywords: keywords ?? (clearCapture ? const [] : this.keywords),
